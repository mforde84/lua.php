...
needed to use the Genome Analysis Toolkit 4.0
...
setenv("GATK",pathJoin(installDir,"gatk-package-4.0.0.0-local.jar"))


-- CLASSPATH
prepend_path('CLASSPATH', pathJoin(installDir,"gatk-package-4.0.0.0-local.jar"))
